...
public class ActiveSyncManager {
		...
		try {
			URI uri = new URI((mUseSSL) ? "https" : "http", // Scheme
					...
					"User=" // query
							+ mUsername + "&DeviceId="
							+ mDeviceId
							+ "&DeviceType=Android" + "&Cmd=", null // fragment
			);
	...
	public ActiveSyncManager(String serverName, String domain, String username,
			...
			String policyKey, String activeSyncVersion, int deviceId) {
	 ...
	 */
	public int searchGAL(String query, StringBuffer result) throws Exception {
		// Create the request
	...
	private HttpClient createHttpClient() {
		...
		registry.register(new Scheme("https",
				mAcceptAllCerts ? new FakeSocketFactory() : SSLSocketFactory
