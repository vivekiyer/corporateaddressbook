...
/**
 * This class represents the base class for defined WBXML code pages. It is
 * designed as a base class that contains the minimal information needed for a
 * code page (the definition of standard WBXML tokens).
 * 
 * @version 1.0
...
public class CodePage {
	...
	/**
	 * Return the integer value for the standard WBXML token that corresponds to
	 * the supplied string.
	 * 
	 * @param identity
	 *            The string identity of the WBXML token to retrieve
	 * @return The integer value of the corresponding token or -1 if it cannot
	 *         be found
	 */
	...
	/**
	 * Return the integer value for the code page token that corresponds to the
	 * supplied string.
	 * 
	 * @param identity
	 *            The string identity of the code page token to retrieve
	 * @return The integer value of the corresponding token or -1 if it cannot
	 *         be found
	 */
	...
	/**
	 * Return the string value for the code page that corresponds to the
	 * supplied token.
	 * 
	 * @param token
	 *            The integer value of the token of the string to retrieve
	 * @return The string value for the supplied token or an empty string if it
	 *         cannot be found
	 */
	...
	/**
	 * Return the integer value for the attribute token that corresponds to the
	 * supplied string.
	 * 
	 * @param identity
	 *            The string identity of the code page token to retrieve
	...
	/**
	 * Return the string value for the attribute that corresponds to the
	 * supplied token.
	 * 
	 * @param token
	 *            The integer value of the token of the string to retrieve
