...
/**
 * This class is the specific code page for ValidateCert in the ActiveSync
 * protocol. The code page number is 11.
 * 
 * @version 1.0
...
public class ValidateCertCodePage extends CodePage {
	/**
	 * Constructor for ValidateCertCodePage. Initializes all of the code page
	 * values.
	 */
