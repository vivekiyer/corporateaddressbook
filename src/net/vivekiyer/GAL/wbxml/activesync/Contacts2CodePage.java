...
/**
 * This class is the specific code page for Contacts2 in the ActiveSync
 * protocol. The code page number is 12.
 * 
 * @version 1.0
...
public class Contacts2CodePage extends CodePage {
	/**
	 * Constructor for Contacts2CodePage. Initializes all of the code page
	 * values.
	 */
