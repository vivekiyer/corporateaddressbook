...
/**
 * This class is the specific code page for DocumentLibrary in the ActiveSync
 * protocol. The code page number is 19.
 * 
 * @version 1.0
...
public class DocumentLibraryCodePage extends CodePage {
	/**
	 * Constructor for DocumentLibraryCodePage. Initializes all of the code page
	 * values.
	 */
