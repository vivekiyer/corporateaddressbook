...
/**
 * This class is the specific code page for ItemEstimate in the ActiveSync
 * protocol. The code page number is 6.
 * 
 * @version 1.0
...
public class ItemEstimateCodePage extends CodePage {
	/**
	 * Constructor for ItemEstimateCodePage. Initializes all of the code page
	 * values.
	 */
