...
/**
 * This class is the specific code page for FolderHierarchy in the ActiveSync
 * protocol. The code page number is 7.
 * 
 * @version 1.0
...
public class FolderHierarchyCodePage extends CodePage {
	/**
	 * Constructor for FolderHierarchyCodePage. Initializes all of the code page
	 * values.
	 */
