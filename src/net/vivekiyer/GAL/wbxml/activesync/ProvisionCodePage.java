...
/**
 * This class is the specific code page for Provision in the ActiveSync
 * protocol. The code page number is 14.
 * 
 * @version 1.0
...
public class ProvisionCodePage extends CodePage {
	/**
	 * Constructor for ProvisionCodePage. Initializes all of the code page
	 * values.
	 */
