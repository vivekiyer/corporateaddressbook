...
/**
 * This class is the specific code page for AirNotify in the ActiveSync
 * protocol. The code page number is 3.
 * 
 * @version 1.0
...
public class AirNotifyCodePage extends CodePage {
	/**
	 * Constructor for AirNotifyCodePage. Initializes all of the code page
	 * values.
	 */
